...
class ChatState(BaseModel):
    ...
    # Add a field to store the keywords of the last successful product search
    last_search_keywords: Optional[str] = None
    # Add a field to store a brief description of the products in the current_view
    current_view_summary: Optional[str] = None
